        ...
        <>
            <div className="container mx-auto mt-10">
                <div className="flex shadow-md my-10 flex-wrap">
                    <div className="w-3/4 bg-white px-10 py-10 lg:basis-[70%] basis-[100%]">
...

                        {
                            cart.map((object, i) => {
                                ...
                                console.log(object)
                                return (
                                    <Cartcomponent value={object} key={i} />
                                )
                    ...
                    <div id="summary" className="w-1/4 px-8 py-10 lg:basis-[30%] basis-[100%]">
        ...
        <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
            <div className="flex w-2/5">
                ...
                <div className="flex flex-col justify-between ml-4 flex-grow">
                    ...
                    <button onClick={() => singleItemRemove()}
